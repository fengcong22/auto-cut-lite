...
skill_candidates = [
    ...
    os.path.join(current_dir, ".trae", "skills", "Auto-Cut"),
    os.path.join(current_dir, ".claude", "skills", "Auto-Cut"),
    os.path.join(current_dir, "skills", "Auto-Cut"),
...
if not scripts_path:
    raise ImportError(
        "Could not find Auto-Cut/scripts/jy_wrapper.py\\nTried:\\n- "
        + "\\n- ".join(attempted)
    )
