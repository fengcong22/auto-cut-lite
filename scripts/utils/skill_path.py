...
def _build_candidates(start_dir: str) -> List[str]:
    ...
    editor_paths = [
        os.path.join(start_dir, ".agent", "skills", "Auto-Cut"),
        os.path.join(start_dir, ".trae", "skills", "Auto-Cut"),
        os.path.join(start_dir, ".claude", "skills", "Auto-Cut"),
        os.path.join(start_dir, "skills", "Auto-Cut"),
        os.path.join(cwd, ".agent", "skills", "Auto-Cut"),
        os.path.join(cwd, ".trae", "skills", "Auto-Cut"),
        os.path.join(cwd, ".claude", "skills", "Auto-Cut"),
        os.path.join(cwd, "skills", "Auto-Cut"),
    ]
...
def ensure_skill_scripts_on_path(start_dir: str) -> str:
    ...
    if not root:
        msg = "Could not find Auto-Cut skill root.\nTried:\n- " + "\n- ".join(attempted)
