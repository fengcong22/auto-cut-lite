...
Use this packaged skill for course/PPT recording review comments that ask to change visual animation timing while preserving an editable JianYing draft. It covers the whole family of animation timing edits: speed-up, full-segment advance, full-screen state overlay, page-turn advance, and anti-collision boundary reading.
