        ...
        for contract in contracts:
            assert_normalized_terms(
                ...
                (
                    ...
                    "end",
                    "match_method",
                    "allowed item-contract delete phrase",
                    "target cut window",
                    "missing, duplicate, tampered, overlapping, or unreported occurrences fail",
                    "single legacy delete_hit_adjudication",
                    "exactly one positive hit",
                    "ordered item-contract delete_phrases",
                    "aggregate display phrase",
                    "uncolored",
                    "automatic must_keep",
