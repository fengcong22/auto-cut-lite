...
Use the repository revision request format defined in [../../docs/revision-input-spec.md](../../docs/revision-input-spec.md).

Start from [../../examples/revision_request_example.json](../../examples/revision_request_example.json) when preparing a new review job.
