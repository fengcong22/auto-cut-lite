...
Use this repository-local skill for document-provided PNG/JPG replacements that must land on a precise local region of an editable JianYing draft. Preserve the source, original image assets, independent cleanup/overlay layers, visible cut structure, and exact review markers.
