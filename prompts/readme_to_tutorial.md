...
*   **Phase 4: Call to Action (End)**
    *   **Visual**: Huge project home / install instruction card.
    *   **Audio (TTS)**: "Follow the project instructions and start your journey today!"

## 3. Generate the Python Script
Write a Python script using `Auto-Cut` skill (`jy_wrapper`) to build this video.
